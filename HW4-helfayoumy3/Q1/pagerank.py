...
def author():                                                                                             
        return "helfayoumy3" # replace gburdell3 with your Georgia Tech username.                                                                                             
...
class PageRank:
    ...
    def run_pagerank(self, node_weights,  damping_factor=0.85, iterations=10):
        ...
        ### Implement your code here
        #############################################
                new_pr_values[target] += pr_values[source] / self.node_degree.get(source)

            pr_values = (1 - damping_factor) * node_weights + damping_factor * np.array(new_pr_values)
        #############################################
