...
class LinearRegressionModel():
    ...
    def lgTrainAccuracy(self,y_train,y_predict_train):
        ...
        train_accuracy = accuracy_score(y_train, (y_predict_train + 0.5).astype(int))
    ...
    def lgTestAccuracy(self,y_test,y_predict_test):
        ...
        # -------------------------------
        # ADD CODE HERE
        test_accuracy = accuracy_score(y_test, (y_predict_test + 0.5).astype(int))
        # -------------------------------
...
# Q3.4.2 Classification
    ...
    def SVCClassifier(self,scaled_x_train,scaled_x_test, y_train):
        ...
        supportVM.fit(scaled_x_train, y_train)

        y_predict_train = supportVM.predict(scaled_x_train)
        y_predict_test = supportVM.predict(scaled_x_test)
...
# Q3.4.3 Hyper-parameter Tuning
    ...
    def SVMBestScore(self, scaled_x_train, y_train):
        ...
        supportVM = SVC(gamma = 'auto')
        svm_cv = GridSearchCV(estimator = supportVM, param_grid = svm_parameters, n_jobs=-1, return_train_score=True)
